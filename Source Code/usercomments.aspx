    ...
    <div id="tooplate_main">
       	<div id="tooplate_content">
           		<div id="homepage_slider">
                        ...
                        <table class="style1">
                           <tr>
                           <td class="style9"> <span class="style11">Posted By</span> :<asp:Label ID="Label1" 
                                   runat="server" Text="Label" style="color: #996633"></asp:Label></td>
                           <td class="style9"><span class="style10">On</span> :<asp:Label ID="Label2" 
                                   runat="server" Text="Label" style="color: #996600"></asp:Label></td>
                           </tr>
                            <tr>
